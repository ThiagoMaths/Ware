...
<head>
    ...
    <meta name="description" content="Curso de JSP"/>
    <meta name="author" content="Thiago Matheus"/>
    <link href="https://fonts.googleapis.com/css?family=Roboto:400,500" rel="stylesheet">
    <link rel="stylesheet" href="<%= request.getContextPath() %>assets/pages/waves/css/waves.min.css" type="text/css"
          media="all">
