        ...
        <ul class="pcoded-item pcoded-left-item">
            <li class="active">
                <a href="<%= request.getContextPath()%>principal/principal.jsp" class="waves-effect waves-dark"
                   style="margin-top: 10px; ">
                    ...
                    <span class="pcoded-mtext" data-i18n="nav.dash.main" style="padding-left: 10px;">Início</span>
            ...
            <li class="pcoded-hasmenu">
                <a href="javascript:void(0)" class="waves-effect waves-dark">
                    ...
                    <span class="pcoded-mtext" data-i18n="nav.basic-components.main" style="padding-left: 10px;">Cadastros</span>
                    <span class="pcoded-mcaret"></span>
                </a>
                        ...
                        <li class=" ">
                            <a href="<%=request.getContextPath() %>/ServletUsuarioController?acao=listarUser"
                               class="waves-effect waves-dark">
                                <span class="pcoded-micon"><i class="fi fi-br-menu-burger"></i></span>
                                <span class="pcoded-mtext" data-i18n="nav.basic-components.alert"
                                      style="padding-left: 10px;">Usuário</span>
                                <span class="pcoded-mcaret"></span>
                            </a>
                        </li>
                    </c:if>
        ...
        <ul class="pcoded-item pcoded-left-item">
            ...
            <li>
                <a href="bs-basic-table.html" class="waves-effect waves-dark">
                    <span class="pcoded-micon"><i class="ti-layers"></i></span>
                    <span class="pcoded-mtext" data-i18n="nav.fo rm-components.main" style="padding-left: 10px;">Estoque</span>
                    <span class="pcoded-mcaret"></span>
                </a>
            </li> -->
