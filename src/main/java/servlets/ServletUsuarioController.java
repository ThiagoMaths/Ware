...
public class ServletUsuarioController extends ServletGenericUtil {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (acao != null && acao.equalsIgnoreCase("deletar")) {
            ...
            } else if (acao != null && acao.equalsIgnoreCase("buscarUserAjax")) {

                String nomeBusca = request.getParameter("nomeBusca");

                List<ModelLogin> dadosJsonUser =
                        daoUsuarioRepository.consultaUsuarioList(nomeBusca, super.getUserLogado(request));

                ObjectMapper mapper = new ObjectMapper();

                String json = mapper.writeValueAsString(dadosJsonUser);

                response.addHeader("totalpagina", STR."\{daoUsuarioRepository
                        .consultaUsuarioListTotalPaginaPaginacao
                                (nomeBusca, super.getUserLogado(request))}");
                ...
                List<ModelLogin> dadosJsonUser = daoUsuarioRepository
                        .consultaUsuarioListOffset(nomeBusca, super.getUserLogado(request),
            ...
            } else if (acao != null && acao.equalsIgnoreCase("buscarEditar")) {

                String id = request.getParameter("id");

                ModelLogin modelLogin = daoUsuarioRepository
                        .consultaUsuarioId(Long.valueOf(id), super.getUserLogado(request));
                ...
                request.setAttribute("totalPagina", daoUsuarioRepository
                        .totalPagina(this.getUserLogado(request)));
                request.getRequestDispatcher("principal/usuario.jsp").forward(request, response);
            ...
            } else if (acao != null && acao.equalsIgnoreCase("imprimirRelatorioUser")) {
                ...
                if (dataInicial == null || dataInicial.isEmpty() && dataFinal == null || dataFinal.isEmpty()) {
                    ...
                    modelLogins = daoUsuarioRepository.consultaUsuarioListRel
                ...
                params.put("PARAM_SUB_REPORT",
                        request.getServletContext().getRealPath("relation") + File.separator);

                byte[] relation = new ReportUtil().geraRelatorioPDF
                        (modelLogins, "rel-user-jsp", params, request.getServletContext());
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Date.valueOf(new SimpleDateFormat("yyyy-mm-dd").format
                    (new SimpleDateFormat("dd/mm/yyyy").parse(dataNascimento)));
            modelLogin.setDataNascimento(new Date(new SimpleDateFormat("dd/mm/yyyy")
                    .parse(dataNascimento).getTime()));
